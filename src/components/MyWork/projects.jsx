...
const Projects = () => {
  ...
  let owlCarouselRef; // Reference to the OwlCarousel component
    ...
    <div className="mywork " id="work">
      ...
      <div className="project-row">
        {projectsDetails?.length && (
          <OwlCarousel className="owl-theme" ref={(ref) => (owlCarouselRef = ref)} {...options}>
      ...
      <div className="carousel-buttons">
        <button className="prev-button" onClick={handleCarouselPrev}>
          <i className="fa fa-chevron-left"></i>
        </button>
        <button className="next-button" onClick={handleCarouselNext}>
